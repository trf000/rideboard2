...
class RB_Carpool {
    ...
    public function init()
    {
        ...
        $db->addColumn('*');
        $db->addJoin('left', 'rb_carpool', 't2', 'dest_address', 'id');
        $db->addColumn('t2.city_state', null, 'dest_address');
    ...
    public function view()
    {
        ...
        $tpl['EMAIL'] = sprintf('<a href="mailto:%s" class="btn btn-default">%s</a>', $this->email, dgettext('rideboard', 'Contact poster'));
